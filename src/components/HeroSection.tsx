...
const HeroSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const SHEETS_URL = 'https://script.google.com/macros/s/AKfycbzLiHk0B5RniAyopJpG-cD22lYTlJUWmvaod_c24vPSwh_3jP-4nbxR8GUY24cQz17s6A/exec';
    ...
    setTimeout(() => {
      window.location.href = 'https://obrigado33.institutodespertamente.site/';
    }, 2000);
  };
